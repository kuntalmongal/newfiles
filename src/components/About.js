  ...
  return (
    <div className="container my-3" style={myStyle
      ...
      <div className="container">
        <button type="button" onClick={toggles} className="btn btn-primary">{btntext}</button></div>
        <div className="form-check form-switch my-4">
<div className="form-check form-switch my-4"/>
    <input className="form-check-input" onClick={toggles} type="checkbox" role="switch" id="flexSwitchCheckDefault" />
